...
clock_surface_white = pygame.Surface((SIZE/4, SIZE/8))
clock_surface_black = pygame.Surface((SIZE/4, SIZE/8))

#panel for captured pieces
white_captured_pieces_surface = pygame.Surface((SIZE*0.3, SIZE*0.3))
black_captured_pieces_surface = pygame.Surface((SIZE*0.3, SIZE*0.3))
...
def blocked(start, finish, board):
    ...
    # am 4 directii pe care pot sa avansez: Ox, Oy, si 2 diagonale
